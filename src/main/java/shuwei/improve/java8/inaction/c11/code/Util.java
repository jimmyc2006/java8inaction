...
public class Util {
    ...
    public static <T> CompletableFuture<List<T>> sequence(List<CompletableFuture<T>> futures) {
        /*
         * CompletableFuture<Void> allDoneFuture = CompletableFuture.allOf(futures.toArray(new
         * CompletableFuture[futures.size()])); return allDoneFuture.thenApply(v -> futures.stream().
